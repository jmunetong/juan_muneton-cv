...
\section{Work Experience}
  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      {Adobe Inc.}{Austin, TX}
      {Software Engineer Intern}{June 2023 \textbf{--} Sep 2023}
        \resumeItemListStart
    ...
    \resumeSubheading
      ...
      {Machine Learning Engineer II}{June 2022 \textbf{--} June 2023}
        \resumeItemListStart
            ...
            \resumeItem{Built a complex-valued module for generalized deep neural network architecture design}
...
Cancer: A Complete Case Analysis. Thesis Advisor: Jon Steingrimsson}
...
\section{Awards \& Achievements}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        \textbf{(2023) GEM Fellowship:}{ Full-ride fellowship to attend a master's program at Stanford University} \\ \vspace{3pt}
        
        \textbf{(2023) Hispanic Scholarship Fund: }{Named Hispanic Scholar through the HSF fund} \\ \vspace{3pt}

        \textbf{(2023) SMART Scholarship (US Department of Defense): }{Scholarship recipient under the Defense Intelligence Agency to attend a STEM graduate-level program (declined)} \\ \vspace{3pt}
        
        \textbf{(2023) Amazon MS Fellowship at Columbia Engineering:}{ A full-tuition fellowship to attend Columbia University for a master's program. In addition, an internship offer at Amazon (declined)} \\ \vspace{3pt}
        
        \textbf{(2021) Departmental Honors in Statistics: }{Awarded to undergraduate students pursuing an honors thesis and remaining in high academic standing} \\ \vspace{3pt}

        \textbf{(2020) (2020) Sprint LINK Award at Brown University: }{Funded award to participate in the development of course material for teaching Data Science at Brown } \\ \vspace{3pt}

        \textbf{(2017) Sydney Frank Scholarship: }{a four-year tuition award to attend Brown University} \\ \vspace{3pt}
...
\section{Skills}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        ...
        \textbf{Technologies:}{ Git, Docker, OpenCV, Pytorch, Tensorflow, Numba, scikit-learn, Linux ISE, Spark, CUDA} \\ \vspace{3pt}
